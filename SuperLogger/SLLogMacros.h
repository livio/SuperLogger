...
#define SLogV(msg, ...) do { if ([SLLoggerController logLevelForFile:__FILE__] >= SLLogLevelVerbose) [SLLoggerController logStringWithLevel:SLLogLevelVerbose fileName:__FILE__ functionName:__PRETTY_FUNCTION__ line:__LINE__ message:msg, ##__VA_ARGS__]; } while(0)
#define SLogD(msg, ...) do { if ([SLLoggerController logLevelForFile:__FILE__] >= SLLogLevelDebug) [SLLoggerController logStringWithLevel:SLLogLevelDebug fileName:__FILE__ functionName:__PRETTY_FUNCTION__ line:__LINE__ message:msg, ##__VA_ARGS__]; } while(0)
