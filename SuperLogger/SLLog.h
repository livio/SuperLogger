...
@property (copy, nonatomic, readonly) NSString *module;
...
- (instancetype)initWithString:(NSString *)string className:(NSString *)className moduleName:(NSString *)moduleName functionName:(NSString *)functionName timestamp:(NSDate *)timestamp NS_DESIGNATED_INITIALIZER;
